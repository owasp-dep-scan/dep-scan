...
```bash
curl -LO https://github.com/appthreat/depscan-bin/releases/download/v4.1.2/depscan-linux-amd64
...
```powershell
curl -LO https://github.com/appthreat/depscan-bin/releases/download/v4.1.2/depscan.exe
.\depscan.exe --help
```
