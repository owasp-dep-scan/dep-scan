...
```bash
curl -LO https://github.com/ngcloudsec/depscan-bin/releases/download/v3.2.0/depscan-linux-amd64
...
```powershell
curl -LO https://github.com/ngcloudsec/depscan-bin/releases/download/v3.2.0/depscan.exe
.\depscan.exe --help
```
