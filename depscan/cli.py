...
def build_parser():
    ...
    parser.add_argument("--profile", default="generic",
                        choices=("appsec", "research", "operational", "threat-modeling", "license-compliance",
                                 "generic", "machine-learning", "ml", "deep-learning", "ml-deep", "ml-tiny",),
                        dest="profile", help="Profile to use while generating the BOM.", )
    ...
    parser.add_argument("--technique", choices=("auto", "source-code-analysis", "binary-analysis", "manifest-analysis",
                                                "hash-comparison", "instrumentation", "filename"), nargs="+", type=str,
                        dest="techniques",
                        help="Analysis technique to use for BOM generation. Multiple values allowed.", )
    parser.add_argument("--bom-engine",
                        choices=("auto", "CdxgenGenerator", "CdxgenServerGenerator", "CdxgenImageBasedGenerator",
                                 "BlintGenerator"), default="auto", dest="bom_engine",
    ...
    parser.add_argument("-o", "--reports-dir",
                        ...
                        dest="reports_dir", help="Reports directory", )
...
def summarise(project_type, results, pkg_aliases, purl_aliases, suggest_mode, scoped_pkgs, bom_file,
    ...
    options = PrepareVdrOptions(project_type, results, pkg_aliases, purl_aliases, suggest_mode, scoped_pkgs=scoped_pkgs,
                                no_vuln_table=no_vuln_table, bom_file=bom_file, direct_purls=direct_purls,
